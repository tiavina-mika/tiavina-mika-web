...
var useStyles = Object(react_jss__WEBPACK_IMPORTED_MODULE_1__["createUseStyles"])({
  presentation: {
    ...
    height: '100vh',
    background: "linear-gradient(180deg, rgba(11,24,46,0) 0%, rgba(0,0,0,0.2) 20.29%, rgba(0,0,0,".concat(bgOpacity - 0.1, ") 80.89%, rgba(0,0,0,").concat(bgOpacity, ") 99.93%)") // backgroundColor: '#171717',
    // backgroundColor: 'red',
...
//# sourceMappingURL=index.js.9c7227eaf29a02051fbc.hot-update.js.map