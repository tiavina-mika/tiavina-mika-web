...
var useStyles = Object(react_jss__WEBPACK_IMPORTED_MODULE_3__["createUseStyles"])(function (theme) {
  ...
  return {
    ...
    menuMobile: function menuMobile(top) {
      return {
        composes: 'flexColumn stretchSelf',
        flex: 1,
        paddingTop: 15,
...
var Menu = function Menu() {
  ...
  console.log('ref: ', (_ref = ref) === null || _ref === void 0 ? void 0 : _ref.current.clientHeight);
  ...
  }), menus.map(function (_ref4, index) {
    var text = _ref4.text,
        url = _ref4.url;
    return menuItem({
      index: index,
...
//# sourceMappingURL=index.js.779a76ac5b9d4e7a33bb.hot-update.js.map