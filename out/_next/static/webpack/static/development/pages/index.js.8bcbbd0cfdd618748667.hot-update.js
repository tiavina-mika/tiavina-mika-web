...
var useStyles = Object(react_jss__WEBPACK_IMPORTED_MODULE_3__["createUseStyles"])(function (theme) {
  ...
  return {
    ...
    knowledgeContent: (_knowledgeContent = {
      composes: 'flexRow justifyCenter alignCenter blue',
      alignSelf: 'center'
    ...
    titleReverse: Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, _utils_constants__WEBPACK_IMPORTED_MODULE_4__["media"].lgUp, {
    ...
    reverse: Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({
      composes: 'red'
...
var Knowledge = function Knowledge(_ref) {
  ...
  return __jsx("div", {
    ...
    text: data.title,
    level: 2,
    className: Object(clsx__WEBPACK_IMPORTED_MODULE_1__["default"])(classes.title, reverse ? classes.titleReverse : null),
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 155,
...
//# sourceMappingURL=index.js.8bcbbd0cfdd618748667.hot-update.js.map