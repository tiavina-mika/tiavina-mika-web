...
var Presentation = function Presentation() {
  ...
  // },
  {
    ...
    // easing: "easeInSine",
    properties: [{
      startValue: 'linear-gradient(180deg, rgba(11,24,46,0) 0%, rgba(0,0,0,0.2) 20.29%, rgba(0,0,0,0.1) 80.89%, rgba(0,0,0,0) 99.93%)',
      endValue: 'linear-gradient(180deg, rgba(11,24,46,0.2) 0%, rgba(0,0,0,0.2) 20.29%, rgba(0,0,0,0.1) 80.89%, rgba(0,0,0,0) 99.93%)',
      property: 'background' // unit: ""
...
//# sourceMappingURL=index.js.92a3a96f9e1b47f7eac1.hot-update.js.map