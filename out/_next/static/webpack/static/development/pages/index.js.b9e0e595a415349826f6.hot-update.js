...
var useStyles = Object(react_jss__WEBPACK_IMPORTED_MODULE_2__["createUseStyles"])(function (theme) {
  return {
    items: Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({
      composes: 'flexColumn stretchSelf center blue',
      paddingLeft: theme.spacing(8)
    }, "paddingLeft", theme.spacing(8)),
    item: {
      composes: 'flexRow center flex1 red'
    },
    texts: {},
    label: {},
    value: {}
...
var ItemsChart = function ItemsChart(_ref) {
  ...
  return __jsx("div", {
    ...
    }, item.value, "/100")), __jsx(_ProgressiveBar__WEBPACK_IMPORTED_MODULE_3__["default"], {
      color: item.color,
      percent: item.value,
      width: 167,
      __self: _this,
...
//# sourceMappingURL=index.js.b9e0e595a415349826f6.hot-update.js.map