...
var Presentation = function Presentation() {
  ...
  // },
  {
    ...
    // easing: "easeInSine",
    properties: [{
      startValue: '`linear-gradient(180deg, rgba(11,24,46,0) 0%, rgba(0,0,0,${bgOpacity - 0.2}) 20.29%, rgba(0,0,0,${bgOpacity - 0.1}) 80.89%, rgba(0,0,0,${bgOpacity}) 99.93%)',
      endValue: '#000',
...
//# sourceMappingURL=index.js.b0550170dd4218e8ab40.hot-update.js.map