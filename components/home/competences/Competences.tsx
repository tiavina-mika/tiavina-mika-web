...
import CompetencesSvg from './svg';
...
const competenceItems = [
    {
        ...
        x: 75,
        label: 'Web',
        icon: function getIcon(): ReactNode {
            return <WebIcon />;
        },
        container: {
            xlinkHref:
